...
$(document).ready(function(){
	...
	function allClientes(){
		...
		$.getJSON(url_proveedores_all + "?id_advance=&a181a603769c1f98ad927e7367c7aa51=b326b5062b2f0e69046810717534cb09",function(data) {
	...
	function oneClientes(id_advance){
		//--->			
			...
			$.getJSON(url_proveedores_one + "?id_advance="+id_advance+"&a181a603769c1f98ad927e7367c7aa51=b326b5062b2f0e69046810717534cb09",function(data) {
